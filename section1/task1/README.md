...
4. For CryptoCompare api documentaions, you don't need a api key for any requests, but some requests that are not required in our task need api key when coding.
